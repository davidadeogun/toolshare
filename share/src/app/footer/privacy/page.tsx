...
export default function PrivacyPage() {
    return (
      <main className={styles.container}>
        ...
        <p className={styles.paragraph}>At Tools Share, accessible from https://, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Tools Share and how we use it.</p>
